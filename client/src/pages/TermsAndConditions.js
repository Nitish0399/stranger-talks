    ...
    return (
      <div>
        ...
        <p>
          ...
          use of Stranger Talks's Website, located at strangertalks.online.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Stranger Talks if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Stranger Talks, you agreed
          to use cookies in agreement with the Stranger Talks's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Stranger Talks and/or its licensors own the
          intellectual property rights for all material on Stranger Talks. All
          intellectual property rights are reserved. You may access this from
          Stranger Talks for your own personal use subjected to restrictions set
        ...
        <p>
          ...
          Stranger Talks does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of Stranger Talks,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Stranger Talks
        ...
        <p>
          Stranger Talks reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Stranger Talks a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Stranger Talks; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Stranger Talks. Please include your name, your
        ...
        <p>
          No use of Stranger Talks's logo or other artwork will be allowed for
